<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CombinedGiving.ascx.cs" Inherits="RockWeb.Plugins.org_crossroadschristian.CombinedGivingBlock.CombinedGiving" %>
        ...
        <asp:Panel ID="pnlContent" runat="server">
            ...
            <div class="panel panel-block">
                <div class="panel-heading">
                    ...
                    <h5 class="panel-familygroup" style="float:right"><i class="fa fa-home"></i><asp:Literal ID="familyGroupNames" runat="server"></asp:Literal></h5>
                </div>
