...
namespace RockWeb.Plugins.org_crossroadschristian.Groups
{
    ...
    /// </summary>
    [DisplayName( "External Group Tree View" )]
    [Category( "Crossroads > Groups" )]
    [Description( "Creates a navigation tree for groups of the configured group type(s), for external site with authenticated users." )]
    ...
    public partial class GroupTreeView : RockBlock
    {
        ...
        private Group FindFirstGroup()
        {
            ...
            { 
                ...
                if ( group.Members.Where( gm => gm.Person.Id == CurrentPerson.Id ) != null )
                {
